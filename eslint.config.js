...
export default tseslint.config(
  {
    // src/convexApi.ts is GENERATED (see its own header comment) - full of
    // `any` by design, same reason infinidraft's eslint.config.js ignores
    // convex/_generated.
    ignores: ["dist", "src/routeTree.gen.ts", "src/convexApi.ts"],
  },
  {
    files: ["**/*.{ts,tsx}"],
